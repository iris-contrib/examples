...
func main() {
	...
	/* Example Output:
	{
	    ...
	    "stacktrace": [
	        {
	            "function": "main.main",
	            "source": "C:/mygopath/src/github.com/iris-contrib/examples/logging/json-logger/main.go:16"
	        }
	    ]
	}
	*/
...
func ping(ctx iris.Context) {
	/* Example Output:
	{
	    ...
	    "stacktrace": [
	        {
	            "function": "main.ping",
	            "source": "C:/mygopath/src/github.com/iris-contrib/examples/logging/json-logger/main.go:82"
	        },
	       ...
	    ]
	}
