...
func main() {
	...
	app.Logger().Handle(func(l *golog.Log) bool {
		...
		/* Example output:
		{"datetime":"2018/10/31 13:13","level":"[INFO]","message":"My server started","source":"c:/mygopath/src/github.com/iris-contrib/examples/http_request/request-logger/request-logger-file-json/main.go#71"}
		*/
		return true
	})
